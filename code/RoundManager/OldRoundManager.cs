...
public sealed class OldRoundManager : Component
{
    public static OldRoundManager Instance { get; private set; }
    ...
    // Networking
    // ========================
    [Sync] public RoundState State { get; private set; } = RoundState.PreStarted;
    ...
    public event Action OnPostFinishStartRound;
    //public event Action OnPostFinishFinishRound;
    ...
    {
        if (EnablePreRound && State == RoundState.PreStarted)
        {
            StartRound_Internal();
            return;
        }
    ...
    public void StartRound()
    {
        ...
        if (State != RoundState.PreStarted)
        {
